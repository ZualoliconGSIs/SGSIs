...
outputname="$name-12.1-$date-$codename-zGSIs"
ioutputname="$name-AB-12.1-$date-$codename-zGSIs"
else
outputname="$name-12-$date-$codename-zGSIs"
ioutputname="$name-AB-12-$date-$codename-zGSIs"
fi
